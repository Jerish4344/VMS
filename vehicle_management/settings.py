...
if not SECRET_KEY:
    raise RuntimeError('DJANGO_SECRET_KEY environment variable is not set. Add it to your .env file.')
...
MIDDLEWARE = [
    ...
    # GZipMiddleware removed — Nginx handles gzip compression at the reverse-proxy layer
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'vms_vms1'),
...
CORS_ALLOW_ALL_ORIGINS = os.environ.get('CORS_ALLOW_ALL', 'False').lower() in ('true', '1', 'yes')  # Explicitly enable in dev via env var
